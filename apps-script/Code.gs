...
var LOCALITIES = {
  ...
  'arapalayam': { name: 'Arappalayam', x: 47.2, y: 37.4 },
  'arasaradi': { name: 'Arasaradi', x: 44.9, y: 40.5 },
  'athikulam': { name: 'Athikulam', x: 62.3, y: 26.6 },
  'avaniyapuram': { name: 'Avaniapuram', x: 51.9, y: 64.1 },
  ...
  'bibikulam': { name: 'Bibikulam (BB Kulam)', x: 57, y: 33.1 },
  ...
  'sikandar-chavadi': { name: 'Sikkandar Chavadi', x: 43.2, y: 17.8 },
  ...
  'tvs-nagar': { name: 'TVS Nagar', x: 48.7, y: 58.1 },
  'uthangudi': { name: 'Uthangudi', x: 79.9, y: 23.6 },
  'vandiyur': { name: 'Vandiyur', x: 73.2, y: 46.7 },
  'vasantha-nagar': { name: 'Vasantha Nagar', x: 45.3, y: 51.1 },
